...
var favoriteBook = Book(title: "The Lord of the Rings", author: "J.R.R. Tolkein", pages: 1000, price: 100.65)
print("I have not read \(favoriteBook.title) by \(favoriteBook.author) because it costs \(favoriteBook.price) and is \(favoriteBook.pages) too long.")
/*:
