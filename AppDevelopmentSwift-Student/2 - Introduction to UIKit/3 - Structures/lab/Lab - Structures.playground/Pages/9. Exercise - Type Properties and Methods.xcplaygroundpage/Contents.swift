...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "James Bondd", email: "jamesbondd@pursuit.org", age: 52)
 ...
 */
User.logIn(user: User(userName: "Ethun Hunter", email: "ehunter@mif.com", age: 40))
