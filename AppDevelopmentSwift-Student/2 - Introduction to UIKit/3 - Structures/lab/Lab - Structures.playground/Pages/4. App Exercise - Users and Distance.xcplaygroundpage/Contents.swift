 ...
 */
var malcolm = User(name: "Malcolm Turnquest", age: 42, height: 69, weight: 190, activityLevel: 7)
print("My name is \(malcolm.name) and I am \(malcolm.age) years old. I am \(malcolm.height) inches tall and weigh \(malcolm.weight) pounds. I have an activity level \(malcolm.activityLevel).")
/*:
 ...
 */
var distanceInMiles = Distance(distanceInMeters: 1600)
print(distanceInMiles)

/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var milesTraveled = Distance(distanceInFeet: 25000)
print(milesTraveled)
