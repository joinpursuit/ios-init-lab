...
let workout = RunningWorkout(distance: 1600, time: 180, elevation: 14)
...
struct Steps {
    var steps: Int {
        willSet {
            if newValue == goal {
                print("Congratulations! You've accomplished your \(goal) steps goal!")
            }
        }
    }
    var goal: Int
...
var stepsWorkout = Steps(steps: 9999, goal: 10000)
stepsWorkout.takeStep()
