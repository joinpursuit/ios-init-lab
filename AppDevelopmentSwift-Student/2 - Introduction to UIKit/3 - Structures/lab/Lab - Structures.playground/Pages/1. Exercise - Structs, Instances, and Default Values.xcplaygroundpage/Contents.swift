 ...
 */
var favoriteBook = Book(title: "Sherlock Holmes", author: "Author Conan Doyale", pages: 250, price: 35.75)
print("My favorite book is \(favoriteBook.title) written \(favoriteBook.author)")
